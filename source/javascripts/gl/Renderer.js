...
class Renderer {
	...
	initBuffers() {
		...
		var coords = new Polygon(3, 1).points;
		var posFloat = new Float32Array(coords.length*2);


		for(var i=0; i<coords.length; i++){
			posFloat[i*2] = coords[i].x
			posFloat[i*2 + 1] = coords[i].y
		}
		...
		this.gl.bufferData(this.gl.ARRAY_BUFFER, posFloat, this.gl.STATIC_DRAW);
