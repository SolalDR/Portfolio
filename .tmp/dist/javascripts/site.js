...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_Bem_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__navigation_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_asap_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_js__ = __webpack_require__(0);
...
window.addEventListener("load", function(){
	...
	__WEBPACK_IMPORTED_MODULE_3_asap_js__["a" /* default */].start({
		targetSelector: "#body",
		sourceSelector: "#body"
	});
	
	// Chargement du background 
	window.bg = new __WEBPACK_IMPORTED_MODULE_0__background_js__["a" /* default */]();
	window.nav = new __WEBPACK_IMPORTED_MODULE_2__navigation_js__["a" /* default */](bg);
...
document.addEventListener("asap:before-load", function (e) {
	...
	}, __WEBPACK_IMPORTED_MODULE_4__config_js__["a" /* default */].anim.load.before)
})
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_polygon__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_object2D__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__background_Cursor_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__background_Wave_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__background_ClipCanvas_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__background_ScrollController_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shaders_background_vert__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shaders_background_vert___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__shaders_background_vert__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shaders_background_frag__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shaders_background_frag___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__shaders_background_frag__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_regl__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_regl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_regl__);
...
class Background {
	...
	constructor() {
		...
		this.elapsedTime = 0;
		this.now = Date.now();
		this.scrollController = new __WEBPACK_IMPORTED_MODULE_6__background_ScrollController_js__["a" /* default */]();
		this.endRaf = Date.now() + 1000;

		this.animationStart = 0;
		
		// Some features
		this.cursor = new __WEBPACK_IMPORTED_MODULE_3__background_Cursor_js__["a" /* default */]();
		this.wave = new __WEBPACK_IMPORTED_MODULE_4__background_Wave_js__["a" /* default */](this.cursor);
	...
	computeMesh(){
		...
		let nW = Math.floor(window.innerWidth / __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].bg.precision) + 1;
		let nH = Math.floor(window.innerHeight / __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].bg.precision) + 1;

		// Total width and height for faces
		let calcW = nW * __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].bg.precision; 
		let calcH = nH * __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].bg.precision; 
		...
		let geometry =  new __WEBPACK_IMPORTED_MODULE_1__helpers_polygon__["a" /* default */](3, wParticule, hParticule).points;

		// Loop and compute each point position
		for(var i=0; i<nW; i++)
		for(var j=0; j<nH; j++)
			this.points.push([ 
				i*__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].bg.precision/calcW * 2 - 1, 
				j*__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].bg.precision/calcH * 2 - 1 
			]);
	...
	smoothScroll(vector){
		this.scrollController.scroll(vector, {
			duration: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].anim.scroll
		});

		this.updateUntil( __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].anim.scroll);
	}
	...
	updateDrawCommand(){
		setTimeout(() => {
			...
			this.drawTriangle = this.regl({
				frag: __WEBPACK_IMPORTED_MODULE_8__shaders_background_frag___default.a, vert: __WEBPACK_IMPORTED_MODULE_7__shaders_background_vert___default.a,
	...
	initRegl(){
		...
		this.computeSize();
		this.regl = __WEBPACK_IMPORTED_MODULE_9_regl__({
		  canvas: this.canvas, 
		  pixelRatio: window.innerHeight/window.innerHeight
		});
		this.clipCanvas = new __WEBPACK_IMPORTED_MODULE_5__background_ClipCanvas_js__["a" /* default */](this.regl);
...
/* unused harmony default export */ var _unused_webpack_default_export = (Object2D);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Object2D_js__ = __webpack_require__(8);
...
class ClipCanvas {
	...
	loadResource(){
		this.arrow = new __WEBPACK_IMPORTED_MODULE_0__Object2D_js__["a" /* default */]({
			width: 100,
			height: 150,
	...
	addRessource(args) {
		var res = new __WEBPACK_IMPORTED_MODULE_0__Object2D_js__["a" /* default */](args);
	...
	displayText(args) {
		var test = new __WEBPACK_IMPORTED_MODULE_0__Object2D_js__["a" /* default */]({
			width: args.size,
			type: "text",
			source: args.text,
	...
	displayArrow(direction){
		...
		if( __WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].guides ){
			this.manageGuides();
			return; 
		}
...
/* harmony default export */ __webpack_exports__["a"] = (ClipCanvas);
...
/* harmony default export */ __webpack_exports__["a"] = (Object2D);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Easing_js__ = __webpack_require__(10);
...
class ScrollController {
	...
	render(current){
		...
		if( this.animate && current < this.end ){
			...
			var advancement = __WEBPACK_IMPORTED_MODULE_0__Easing_js__["a" /* default */].easeInOutCubic( 1 - (this.end - current) / this.duration );
...
/* harmony default export */ __webpack_exports__["a"] = (ScrollController);
...
/* harmony default export */ __webpack_exports__["a"] = (EasingFunctions); 
...
/* unused harmony default export */ var _unused_webpack_default_export = (BemElement);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__single_home_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__single_skills_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__single_contact_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__single_works_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__single_about_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_js__ = __webpack_require__(0);
...
class Navigation {
	...
	get currentScript(){
		switch( this.currentPage ) {
			case "home": return __WEBPACK_IMPORTED_MODULE_0__single_home_js__["a" /* default */];
			case "project": return project;
			case "skills": return __WEBPACK_IMPORTED_MODULE_1__single_skills_js__["a" /* default */];
			case "works": return __WEBPACK_IMPORTED_MODULE_3__single_works_js__["a" /* default */];
			case "about": return __WEBPACK_IMPORTED_MODULE_4__single_about_js__["a" /* default */];
			case "contact": return __WEBPACK_IMPORTED_MODULE_2__single_contact_js__["a" /* default */];
		}
	} 
	...
	execute(){
		setTimeout(()=>{
			...
			this.bg.updateUntil();
		}, __WEBPACK_IMPORTED_MODULE_5__config_js__["a" /* default */].anim.load.after)
	}
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	init: function(ctx){
		this.ctx = ctx;
		this.ctx.bg.clipCanvas.displayArrow("none");
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ProgressBar_js__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	init: function(ctx){
		...
		for(var i=0; i<els.length; i++){
			progresses.push(new __WEBPACK_IMPORTED_MODULE_0__ProgressBar_js__["a" /* default */](els[i]));
		}
	}
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__project_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_js__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	displayProject(el, block){
		...
		if( !el.className.match("projects__item-container--full")){
			...
			setTimeout(() => {
				__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce = 100000
			}, 1000)
		}
	...
	hideProject(el, block){
		...
		setTimeout(function(){
			console.log(__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce);
			__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce = 3000;
		}, 1000)
	...
	initProject(block, blockPerspective, blockContainer){
		...
		var project = new __WEBPACK_IMPORTED_MODULE_0__project_js__["a" /* default */](block, this);
	...
	moverEvent(el, elFrame){
		...
		var render = function(){
			...
			elFrame.setAttribute("style", `transform: matrix3d(1,0,0.00, ${x/__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce},0.00,1, 0.00, ${y*2/__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce},0,0,1,0,0,0,0,1)`) 
		...
		elFrame.addEventListener("mousemove", function(e) {
			...
			elFrame.setAttribute("style", `transform: matrix3d(1,0,0.00, ${x/__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce},0.00,1, 0.00, ${y/__WEBPACK_IMPORTED_MODULE_1__config_js__["a" /* default */].matrixForce},0,0,1,0,0,0,0,1)`) 
		});
	}
